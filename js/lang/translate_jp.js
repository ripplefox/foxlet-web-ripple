...
var translate_jp = {
  ...
  you_cancel: 'あなたは以下の注文をキャンセルしました　注文内容：',
  you_cancel_buy: 'あなたは以下の注文をキャンセルしました 以下の資産を購入します',
  you_cancel_sell: 'あなたは以下の注文をキャンセルしました 以下の資産を売却します',
  ...
  /** Error **/
  NotFoundError : '該当アカウントが見つかりませんでした。アクティブ化してください。アクティブ化には10枚以上の{{code}}が必要です。与信する、注文するたびにはさらに2枚の{{code}}が必要です。20枚以上の {{code}}でアクティブ化することをお勧めします。',
